...
import 'package:resume_app/data/repositories_impl/about_repository_impl.dart';
...
Future<void> initGetIt() async {
  ...
  getIt.registerSingleton<AboutRepository>(AboutRepositoryImpl());
  ...
  getIt.registerSingleton(GetAboutUsecase(repo: getIt()));
  ...
  getIt.registerSingleton(AboutMeBloc(getIt()));
}
